...
class OfferServiceValidationTest {
  ...
  @Test
  void createOffer_whenMissingProductId_throwsConstraintViolationException() {
    // arrange
    ...
    // act + assert
    assertThatThrownBy(() -> useCase.createOffer(command))
        .isInstanceOf(ConstraintViolationException.class);
  }

  @Test
  void createOffer_whenMissingCode_throwsConstraintViolationException() {
    // arrange
    final var command = new ManageOfferUseCase.CreateOfferCommand(
  ...
  @Test
  void createOffer_whenEmptyCode_throwsConstraintViolationException() {
    // arrange
    final var command = new ManageOfferUseCase.CreateOfferCommand(
        OfferGenerator.DEFAULT_PRODUCT_ID,
        Code.NONE,
  ...
  @Test
  void createOffer_whenMissingPrice_throwsConstraintViolationException() {
    // arrange
    final var command = new ManageOfferUseCase.CreateOfferCommand(
        OfferGenerator.DEFAULT_PRODUCT_ID,
        OfferGenerator.DEFAULT_CODE,
  ...
  @Test
  void createOffer_whenInvalidPrice_throwsConstraintViolationException() {
    // arrange
    final var command = new ManageOfferUseCase.CreateOfferCommand(
        OfferGenerator.DEFAULT_PRODUCT_ID,
        OfferGenerator.DEFAULT_CODE,
